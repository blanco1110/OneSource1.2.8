class RepairOrderItemsController < ApplicationController
  ...
  private
    ...
    def repair_order_item_params
      params.require(:repair_order_item).permit(:device_component_id, :technician_id, :warranty_expire_date, :warranty_coverage_notes, :repaired_as_warranty, :warranty_repair_date, :device_id)
    end
end
