...
class DevicePreTestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device_pre_test" do
    assert_difference('DevicePreTest.count') do
      post device_pre_tests_url, params: { device_pre_test: { device_id: @device_pre_test.device_id, pre_test_condition: @device_pre_test.pre_test_condition, test_id: @device_pre_test.test_id } }
    end
  ...
  test "should update device_pre_test" do
    patch device_pre_test_url(@device_pre_test), params: { device_pre_test: { device_id: @device_pre_test.device_id, pre_test_condition: @device_pre_test.pre_test_condition, test_id: @device_pre_test.test_id } }
