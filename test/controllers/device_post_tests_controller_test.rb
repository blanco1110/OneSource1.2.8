...
class DevicePostTestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device_post_test" do
    assert_difference('DevicePostTest.count') do
      post device_post_tests_url, params: { device_post_test: { device_id: @device_post_test.device_id, post_test_condition: @device_post_test.post_test_condition, test_id: @device_post_test.test_id } }
    end
  ...
  test "should update device_post_test" do
    patch device_post_test_url(@device_post_test), params: { device_post_test: { device_id: @device_post_test.device_id, post_test_condition: @device_post_test.post_test_condition, test_id: @device_post_test.test_id } }
